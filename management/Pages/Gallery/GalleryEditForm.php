...
<?php 
	...
	$Gallery->ID = $ID;
	$lineGallery = $Gallery->GalleryFindID();
?>
	<script>
		...
		?>
			<div class="box-inner">
				<div class="box-header well" data-original-title="">
					<h2><i class="glyphicon glyphicon-edit"></i> Galeri Düzenle</h2>
				...
				<div class="box-content">
					<form role="form" id="GalleryForm" name="GalleryForm" method="POST" enctype="multipart/form-data" action="<?php echo Defined::PROFILE ?>?func=Gallery&File=GalleryEdit&GalleryMainMenuID=<?php echo $Gallery->GalleryMainMenuID; ?>&GalleryCategoriesID=<?php echo $Gallery->GalleryCategoriesID; ?>&ID=<?php print $ID; ?>">
						
						<div class="form-group "><!-- col-lg-offset-right-1 col-md-offset-right-1 col-sm-offset-right-1 col-xs-offset-right-2 -->
							<label for="">Başlık</label>
							<input type="text" class="form-control  validate[required]" name="Name" placeholder="Başlık Giriniz" value="<?php print $lineGallery->Name; ?>">
						</div>
						
						<div class="form-group "><!-- col-lg-offset-right-1 col-md-offset-right-1 col-sm-offset-right-1 col-xs-offset-right-2 -->
							<label for="">URL</label>
							<input type="text" class="form-control" name="Link" placeholder="Adres Giriniz" value="<?php print $lineGallery->Link; ?>">
						</div>
						<div class="form-group">
							<label for=""></label>
							<img src="../Uploads/Gallery/Big/<?php print $lineGallery->Images; ?>"  height="150">
						</div>
						<div class="form-group">
						...
						<button type="submit" name="GalleryEdit" class="btn btn-primary">Gönder</button>
						</div>
					</form>
